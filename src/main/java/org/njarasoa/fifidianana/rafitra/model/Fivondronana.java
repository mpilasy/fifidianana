...
class Fivondronana extends IdValuePair {
    private List<Firaisana> firaisanaList;
    private final Faritra parent;
    ...
    String anaranaFeno() {
        return MessageFormat.format("{0}{1}{2}", parent.getAnarana(), LisitraBiraoProcessor.SEPARATOR, anarana);
    }
